// src/components/interactive/Navigation.tsx
    ...
    <nav className="navigation">
      <div className="navigation__container">
        ...
        <div className="navigation__actions">
          {user ? (
            <>
              {/* Přepínání mezi /game a /interactive */}
              {isInteractivePage ? (
                <button
                ...
                >
                  <Gamepad2 size={18} />
                  <span className="navigation__button-text">Hlavní hra</span>
                </button>
              ) : !isGamePage && (
                <button
                ...
                >
                  <Gamepad2 size={18} />
                  <span className="navigation__button-text">Interaktivní mapa</span>
                </button>
              )}
